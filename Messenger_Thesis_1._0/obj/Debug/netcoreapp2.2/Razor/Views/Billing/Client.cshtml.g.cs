#pragma checksum "C:\Users\Administrator\Desktop\Durogpepe\Messenger2\Messenger_Thesis_1._0\Views\Billing\Client.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2acbfecd97c443e6e8ed9f6f1eb35c297b9eed8d"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2acbfecd97c443e6e8ed9f6f1eb35c297b9eed8d", @"/Views/Billing/Client.cshtml")]
...
<div class=""container-fluid mt--7"">
    ...
    <div class=""row"">
        <div class=""col"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2acbfecd97c443e6e8ed9f6f1eb35c297b9eed8d7145", async() => {
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2acbfecd97c443e6e8ed9f6f1eb35c297b9eed8d13379", async() => {
            }
            );
...
<script>
    ...
    function GetAllUser(page) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"class=""btn btn-block"" data-toggle=""modal"" data-target=""#modal-form""  onclick=""PassDetails(\'' + e[key].projectName + '\',' + e[key].projectID + '); ShowForm();"" >settle</button>'
                    }
    ...
    function Page1() {
        ...
        $.ajax({
            ...
            success: function (e) {
                ...
                for (var key of Object.keys(e)) {
                    ...
                    var t = '       <tr> ' +
                        ...
                        '     <img alt=""Image placeholder"" style=""height:50px;"" src=""../Images/' + ");
            WriteLiteral(@"e[key].imageName + '   "">' +
                        '   </a>' +
                        '       <div class=""media-body"">' +
            ...
            WriteLiteral(@"=""../assets/img/theme/team-1-800x800.jpg"" class=""rounded-circle"">' +
                        '     </a>' +
...
");
    ...
    function Page3() {
        ...
        ");
            ...
            WriteLiteral(@" role=""progressbar"" aria-valuenow=""60"" aria-valuemin=""0"" aria-valuemax=""100"" style=""width: 60%;""></div>' +
                        ' </div>' +
                        '   </div>' +
                        ' </div>' +
                        ' </td>' +
    ...
    $('#update-submit-admin').click(function () {
        ...
        var cpassword = $('");
            WriteLiteral(@"#update_cpassword_admin').val();
        ...
        $.ajax({
            ...
            WriteLiteral(@"   $('.update_firstNameValidation_admin').html(""Please write your first name"");
                ...
                if (e == ""lastname_required"") {
                    ...
                    $('.update_lastNameValidation_admin");
            WriteLiteral(@"').html(""Please write your last name"");
